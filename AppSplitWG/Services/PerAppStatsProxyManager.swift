...
/// Manages the `NETransparentProxyManager` configuration that powers per-app TX/RX
...
final class PerAppStatsProxyManager {
    private static let osLog = Logger(subsystem: "com.appsplit.wg", category: "PerAppStatsProxy")

    static let extensionBundleIdentifier = "com.appsplit.wg.transparentproxy"
    static let managerDescription = "AppSplit WG Per-App Stats"
    ...
    func enable() async throws {
        ...
        proto.serverAddress = "AppSplit WG Per-App Stats"

...
@main
struct AppSplitWGApp: App {
    private static let osLog = Logger(subsystem: "com.appsplit.wg", category: "App")
    ...
    private func refreshMenuBar() {
        ...
        let plannedModeLabel = selectedRoutedApps > 0 ? "Per-App" : "Full Tunnel"
        let activeModeLabel = appState.vpnManager.stats.perAppSplitTunnelActive ? "Per-App" : "Full Tunnel"
